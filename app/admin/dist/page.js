    ...
    return (React.createElement("main", { className: "min-h-screen bg-black text-white flex flex-col items-center justify-center p-6" },
        ...
        React.createElement("div", { className: "flex flex-col gap-4 w-full max-w-sm" },
            ...
            role === "ADMIN" && (React.createElement(React.Fragment, null,
                ...
                React.createElement("button", { onClick: function () { return router.push("/admin/tickets"); }, className: "bg-pink-600 hover:bg-pink-700 text-white px-6 py-3 rounded-lg text-xl font-semibold" }, "Ticket Management"),
                React.createElement("button", { onClick: function () { return router.push("/admin/raffle"); }, className: "bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-3 rounded-lg text-xl font-semibold" }, "Raffle Draw"))),
