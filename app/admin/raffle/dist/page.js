...
function AdminRaffleMenu() {
    ...
    return (React.createElement("main", { className: "min-h-screen bg-black text-white flex flex-col items-center p-10" },
        ...
        React.createElement("div", { className: "flex flex-col gap-6 w-full max-w-sm" },
            React.createElement("button", { onClick: function () { return router.push("/admin/raffle/management"); }, className: "bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-4 rounded-lg text-xl font-semibold" }, "Raffle Management"),
