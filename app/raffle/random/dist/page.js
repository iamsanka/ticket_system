...
function RandomRafflePage() {
    ...
    return (React.createElement("div", { className: "min-h-screen flex flex-col items-center bg-black text-white overflow-hidden relative pb-40" },
        ...
        React.createElement("h1", { className: "text-6xl font-extrabold text-yellow-400 mt-10 mb-10" }, "Random Raffle Draw"),
        ...
        showResults && (React.createElement("div", { className: "w-full flex flex-wrap justify-center items-start gap-10 mt-10 px-10" },
