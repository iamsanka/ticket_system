...
function POST(req) {
    return __awaiter(this, void 0, void 0, function () {
        var body, amount, _a, currency, metadata, paymentIntent, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    body = _b.sent();
                    amount = body.amount, _a = body.currency, currency = _a === void 0 ? "eur" : _a, metadata = body.metadata;
                    if (!amount || amount <= 0) {
                ...
                case 3:
                    error_1 = _b.sent();
                    console.error("Error creating PaymentIntent:", error_1);
