    ...
    return __generator(this, function (_e) {
      switch (_e.label) {
        ...
        case 2:
          ...
          subtotal = adultLounge * event.adultLoungePrice + adultStandard * event.adultStandardPrice + childLounge * event.childLoungePrice + childStandard * event.childStandardPrice;
        ...
        case 4:
          ...
          if (!(paymentMethod === "edenred" || paymentMethod === "epassi")) return [3
          /*break*/
          , 6];
          return [4
          /*yield*/
        ...
        case 12:
          ...
          /*return*/
          , noCacheJson({
            error: error_1.message || "Checkout failed"
          }, 500)];
