...
function GET() {
    return __awaiter(this, void 0, void 0, function () {
        var config, codes, tickets, byCode;
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (!config || !config.enabled) {
                        return [2 /*return*/, server_1.NextResponse.json({ enabled: false })];
                    }
                    codes = [
                    ...
                    return [4 /*yield*/, prisma_1.prisma.ticket.findMany({
                            where: {
                                ticketCode: { "in": codes.map(function (c) { return c.code; }) }
                            },
                            include: {
                                order: {
                                    include: {
                ...
                case 2:
                    tickets = _a.sent();
                    byCode = new Map(tickets.map(function (t) { return [t.ticketCode, t]; }));
