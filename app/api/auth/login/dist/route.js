...
function POST(req) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, email, password, user, valid, res;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    user = _b.sent();
                    if (!user) {
                        return [2 /*return*/, server_1.NextResponse.json({ ok: false, error: "Invalid email or password" }, { status: 401 })];
                    }
                ...
                case 3:
                    ...
                    res = server_1.NextResponse.json({ ok: true, role: user.role });
