            ...
            switch (_a.label) {
                ...
                case 2:
                    ...
                    if (!order || order.paid || order.tickets.length > 0) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: "Cannot delete paid or ticketed order" }, { status: 400 })];
                    }
                    return [4 /*yield*/, prisma_1.prisma.order["delete"]({ where: { id: orderId } })];
                case 3:
                    _a.sent();
                    return [2 /*return*/, server_1.NextResponse.json({ success: true })];
                case 4:
                    error_1 = _a.sent();
                    console.error("Delete order error:", error_1);
