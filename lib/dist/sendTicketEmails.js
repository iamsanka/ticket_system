...
var generateInvoiceImageForAdmin_1 = require("./generateInvoiceImageForAdmin");
function sendTicketEmail(_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var transporter, ticketAttachments, invoiceImageBuffer, _c, invoicePdfBuffer, formattedDate, emailHtml;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    if (!(order.status === "manual")) return [3 /*break*/, 2];
                    return [4 /*yield*/, generateInvoiceImageForAdmin_1.generateInvoiceImageForAdmin(order, tickets)];
                case 1:
                    _c = _d.sent();
                    return [3 /*break*/, 4];
                case 2: return [4 /*yield*/, generateInvoiceImage_1.generateInvoiceImage(order, tickets)];
                case 3:
                    _c = _d.sent();
                    _d.label = 4;
                case 4:
                    invoiceImageBuffer = _c;
                    return [4 /*yield*/, invoiceImageToPdf_1.invoiceImageToPdf(invoiceImageBuffer)];
                case 5:
                    invoicePdfBuffer = _d.sent();
